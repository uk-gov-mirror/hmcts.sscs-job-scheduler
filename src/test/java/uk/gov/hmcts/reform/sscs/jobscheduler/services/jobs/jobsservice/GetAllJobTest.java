...
import static uk.gov.hmcts.reform.sscs.jobscheduler.services.jobs.SchedulerExceptionHandlingHelper.call;
...
public class GetAllJobTest {
    ...
    private Page<JobData> setUpAndRetrieve(int total, int page, int size) throws SchedulerException {
        ...
        when(actionSerializer.deserialize("value")).thenReturn(SampleData.validJob().action);
